...
| `results/example_quantcheck_report.json` (CLI example, matches published 160m values) | `python quantcheck.py --model EleutherAI/pythia-160m --revisions step84000,step143000 --bits 4 --dtype fp32` |
